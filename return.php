                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="editstudent.php?id=<?php echo $row["product_id"] ?>" class="btn btn-sm btn-warning">Edit</a>
                                        <a href="logs.php?id=<?php echo $row["product_id"] ?>" class="btn btn-sm btn-danger">Return</a>
                                    </div>
                                </td>
                            </tr>
                            <?php
